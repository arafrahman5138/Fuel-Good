...
from app.models import recipe_embedding as recipe_embedding_model, notification as notification_model  # noqa: F401

settings = get_settings()
DEFAULT_DEV_SECRET = "dev-secret-key-change-in-production"
app_logger = logging.getLogger("wholefoodlabs.api")
