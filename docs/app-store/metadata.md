...
Whole-food scans and meal guidance

## Keywords

nutrition,whole food,meal scan,healthy eating,recipes,wellness
...
- Camera and photo access only when you choose to scan
...
- The app uses App Store auto-renewable subscriptions for full access after onboarding.
- Plans: `$9.99/month` and `$49.99/year`.
- Both plans offer a `7-day free trial`.
- The first iOS launch is not free beyond onboarding unless a subscription trial or purchase is started.
- Do not mention Stripe, external checkout, or off-platform payment for digital app access in iOS store copy.
