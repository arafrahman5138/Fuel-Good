...
| Bundle ID consistent across app, Apple services, OAuth | Partial | Engineering | Final Apple/OAuth console validation | Bundle ID matches `com.fuelgood.ios` everywhere |
